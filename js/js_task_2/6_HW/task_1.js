...
// для знаходимо елемент з ідентифікатором "categories", а саме, список УЛ з ідентифікатором "categories" і зберегли його у змінній categories.

console.log(`Number of categories: ${categories.children.length}`);

// виводимо к-сть дочірніх елементів у списку УЛ з ідентифікатором - categories. за допомогою властивості children.length - к-сть елементів item в списку
console.log(' ');
