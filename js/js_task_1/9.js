...
/*
return - оператор повернення значення з функції.
function назва(){ return значення;}
назва - назва функції.

значення - значення яке повертається оператором return.
return оператор який повертає значення з функції. За допомогою оператора return повертається результат виконання функції.
